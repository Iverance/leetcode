...
#     assert s.removeComments(["void func(int k) {", "// this function does nothing /*", "   k = k*2/4;", "   k = k/2;*/", "}"]) == ["void func(int k) {","   k = k*2/4;","   k = k/2;*/","}"]
